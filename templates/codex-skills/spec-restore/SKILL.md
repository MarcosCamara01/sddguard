---
name: spec-restore
description: Restore a spec folder from a snapshot in .sdd/snapshots/. Use when an amendment or implementation step has corrupted the spec and reverting is faster than re-amending.
---
